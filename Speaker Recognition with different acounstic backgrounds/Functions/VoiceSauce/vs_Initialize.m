...
vars.lpcOrder = 12; % Soo : default LPC order
vars.NotANumber = '0';
...
vars.FormantsPraatMaxFormantFreq = 6000;
vars.FormantsPraatNumFormants = 4;

vars.BandwidthMethods = {'Use formula values', 'Use estimated values'};
vars.BandwidthMethod = 'Use formula values';
...
vars.FMTalgorithm = 'Formants (Snack)';
...
vars.OT_outputAlgorithmMetadata = 0;
...
vars.OT_Epochfilename = 'Epoch.txt'; % Soo
...
vars.OT_Epoch = [vars.OT_outputdir vars.OT_Epochfilename]; % Soo
